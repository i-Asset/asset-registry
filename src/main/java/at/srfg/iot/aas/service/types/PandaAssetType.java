...
public class PandaAssetType {
    ...
    protected void init() {
        ...
        AssetAdministrationShell theShell = applicationTypeAAS.orElseGet(() -> {
        ...
        Submodel infoModel = assetTypeInfoModel.orElseGet(() -> {
        ...
        GlobalReference manufacturerName = optManufacturerReference.orElseGet(() -> {
        ...
        ConceptDescription manufacturer = manufacturerDescription.orElseGet(() -> {
            ConceptDescription manufacturer1 = new ConceptDescription(new Identifier("http://iasset.salzburgresearch.at/dictionary/manufacturer"));
            manufacturer1.setCategory(CategoryEnum.PROPERTY);
            manufacturer1.setDescription("en", "Manufacturer name");
            manufacturer1.setDescription("de", "Hersteller Name");
...
//				manufacturer.addCaseOf(manufacturerName);
            ...
            return cdRepo.save(manufacturer1);
        });
        ...
        Property manufacturerProperty = optManufacturer.orElseGet(() -> {
            //
        ...
        Submodel propertyModel = assetTypePropertyModel.orElseGet(() -> {
        ...
        SubmodelElementCollection pandaPosition = optPandaPosition.orElseGet(() -> {
        ...
        Property posX = optPosX.orElseGet(() -> {
            //
        ...
        Property posY = optPosY.orElseGet(() -> {
            //
        ...
        Property posZ = optPosZ.orElseGet(() -> {
            //
        ...
        SubmodelElementCollection pandaGripper = optPandaGripper.orElseGet(() -> {
        ...
        Property gripperDistance = optGripperDistance.orElseGet(() -> {
            //
        ...
        Property gripperZForcee = optGripperDistance.orElseGet(() -> {
            //
            ...
            // TODO: define semantic id for zForce
            // property.setSemanticElement(manufacturer);
            property.setValueQualifier(DataTypeEnum.DECIMAL);
            return aasSubmodelElementRepo.save(property);
        });

        Property gripperType = optGripperDistance.orElseGet(() -> {
            //
            ...
            // TODO: define semantic id for gripper type
            // property.setSemanticElement(manufacturer);
            property.setValueQualifier(DataTypeEnum.STRING);
            return aasSubmodelElementRepo.save(property);
        });
        ...
        Submodel operationModel = assetTypeOperationModel.orElseGet(() -> {
        ...
        Operation moveToPosition = optMoveToPosition.orElseGet(() -> {
        ...
        OperationVariable posXInput = optPosXInput.orElseGet(() -> {
        ...
        OperationVariable posYInput = optPosYInput.orElseGet(() -> {
        ...
        OperationVariable posZInput = optPosZInput.orElseGet(() -> {
        ...
        Submodel eventModel = assetTypeEventModel.orElseGet(() -> {
        ...
        EventElement stateEvent = optStateEvent.orElseGet(() -> {
